...
-- Dumping data for table preorder.barang: ~8 rows (approximately)
...
REPLACE INTO `barang` (`kd_barang`, `nama`, `kuantitas`, `harga`, `warna`, `ukuran`, `gambar`) VALUES
	...
	('es', 'es', NULL, 23, '23', '23', NULL),
	('UHsd2', 'sadas', NULL, 452223, '333f', '34d34f', NULL);
...
REPLACE INTO `pesanan` (`kd_pesanan`, `tgl_pesanan`, `cara_bayar`, `jatuh_tempo`, `catatan`, `uang_muka`, `sisa_bayar`, `kd_pembeli`, `sts_pesanan`, `kd_admin`) VALUES
	('23', NULL, '', NULL, NULL, NULL, NULL, '', '', 'AD001');
